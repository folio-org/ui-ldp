...
module.exports = function (req, res) {
  ...
  res.write(new Buffer("negl5kf935jr9QsAAP//itXhAgAAAP//", "base64"));
  res.write(new Buffer("AsZmSX5JYk4QOPBBUWqowwUAAAD//w==", "base64"));
  res.write(new Buffer("AgoWpRYDg9gzLy0fKFSNpsZQRyktMTkVGE2gUAMGZWJ6Xn5xSWYyWKCWqxYAAAD//wMAFvpo4iYCAAA=", "base64"));
  res.end();
