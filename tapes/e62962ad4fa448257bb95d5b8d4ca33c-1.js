...
module.exports = function (req, res) {
  ...
  res.setHeader("date", "Thu, 30 Sep 2021 18:55:28 GMT");
  res.setHeader("connection", "keep-alive");
  res.setHeader("vary", "origin");
  res.setHeader("access-control-allow-origin", "*");
  res.setHeader("access-control-expose-headers", "location,X-Okapi-Trace,X-Okapi-Token,Authorization,X-Okapi-Request-Id,X-Okapi-Module-Id");
  res.setHeader("x-okapi-trace", "PUT mod-authtoken-2.10.0-SNAPSHOT.92 http://10.36.1.13:9177/configurations/entries/590d2f50-ae9a-415c-bba4-45a885671f09 : 202 14605us, PUT mod-configuration-5.8.0-SNAPSHOT.97 http://10.36.1.13:9133/configurations/entries/590d2f50-ae9a-415c-bba4-45a885671f09 : 204 6286us");
