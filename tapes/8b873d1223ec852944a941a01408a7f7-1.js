...
module.exports = function (req, res) {
  ...
  res.write(new Buffer("UlBQSs7PS8tML1ayUojmAgAAAP//itXhAgAAAP//AoqU5Jck5gSlJucXpYCEDXS4AAAAAP//AgoWpRaX5pR45qXlA4Wq0dQY6CilJSanlgCZ0bE6SimZiel5+cUlmclggVquWgAAAAD//w==", "base64"));
  res.write(new Buffer("AwBSCluhagAAAA==", "base64"));
  res.end();
