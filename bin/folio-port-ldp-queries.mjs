...
// Run as: env LOGCAT=status,ldp OKAPI_URL=https://folio-snapshot-okapi.dev.folio.org OKAPI_TENANT=diku OKAPI_USER=diku_admin OKAPI_PW=swordfish ./folio-port-ldp-queries.mjs RandomOtherGuy ldp-queries
